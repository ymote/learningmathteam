...
我们已经学过如何处理多项式——求根、因式分解、分析当 $x \to \pm\infty$ 时的行为，以及配方、圆锥曲线和旋转。现在我们迈出下一步：**用一个多项式除以另一个**来构造*有理函数*。这正是在预备微积分和微积分中不断出现的函数类型，从对现实现象建模到分析变化率。本课的核心问题是：*当 $x$ 变得极大时，有理函数是什么样的？*
