...
考虑幂次方末位数字的规律。例如，$7^1 = 7$，$7^2 = 49$，$7^3 = 343$，$7^4 = 2401$——末位数字循环出现：7, 9, 3, 1, 7, 9, 3, 1, ... 这种循环行为并非巧合，而是由数论中的深刻定理所决定的：**费马小定理**及其通过**欧拉函数**的推广。
...
设有 $n$ 颗糖果。分给 $7$ 个人还剩 $3$ 颗；分给 $11$ 个人还剩 $5$ 颗。
