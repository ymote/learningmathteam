...
我们已经学过如何画二次函数的图像——找到顶点、对称轴和截距，就能得到一条抛物线。但当 $x$ 的最高次幂是**三**而不是二时，会发生什么呢？三次多项式产生S形曲线，最多可以有两个转折点，它们的图像具有美妙的**点对称性**（180度旋转对称），而不是轴对称。

本课介绍一种强大而系统的手绘任意因式分解多项式的方法——**蛇形法**——然后将其推广到具有垂直渐近线和斜渐近线的**有理函数**。在此过程中，我们练习**多项式长除法**，这是求斜渐近线和化简有理表达式的关键工具。
