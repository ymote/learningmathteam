...
Recall that $\cos\theta = \tfrac{1}{2}$ has infinitely many real solutions. But what happens when we attempt to solve $\cos\theta = 2$? No real angle has a cosine exceeding 1.
