...
Conic sections are the family of curves you get by slicing a cone at different angles: circles, ellipses, parabolas, and hyperbolas. We have previously studied circles ($x^2 + y^2 = r^2$) and parabolas ($y = ax^2$). This lesson explores the next two members of that family --- the **ellipse** and the **hyperbola** --- and reveals how they are connected through their *focal point* properties. An ellipse may be viewed as a stretched circle, and a hyperbola as its "inside-out" counterpart. Both curves are defined by distance conditions involving two special points called **foci**.
...
The parabola may be understood as the case where one focus has moved to infinity while the other stays fixed, and the constant sum/difference also tends to infinity.
