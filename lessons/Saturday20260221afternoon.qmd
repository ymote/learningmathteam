...
Think of the simplest case: $u = x + 2$. The $u$-axis origin is shifted **right** by 2 in the $x$-world. But to convert, you need to **subtract**: a point at $x = 2$ maps to $u = 0$. The coordinate transformation always goes in the opposite direction of the geometric transformation.
